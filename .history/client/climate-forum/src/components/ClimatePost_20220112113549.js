...
export default function ClimatePost({eachPost, loading}) {
    ...
    return (
        ...
        >
            ...
            <Grid fluid item xs={8} sx={{ borderColor: 'primary.main', borderRadius: 1 }}>
                    ...
                    eachPost.comments.map(eachComment => {
                        if (eachComment === []) {
                            ...
                            <Box sx={{ borderColor: 'primary.main', borderRadius: 1 }}>
                                <p>@{eachComment.username} : {eachComment.body}</p>
            ...
            <Grid fluid item xs={4} sx={{ borderColor: 'primary.main', borderRadius: 1 }}>

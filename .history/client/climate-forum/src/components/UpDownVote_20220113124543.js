...
function UpDownVote({eachPostId}) {
        ...
        array.map(entry => {
            return (
                <div>
                    <p>{entry.name}</p>
                    <p>{entry.age}</p>
                    <button>Click to get ID of entry</button>
                </div>
    ...
    return (
        <div>
            <div className="like-dislike-bttns">
                <Button onClick={(event) => console.log(event.target)} variant="contained" endIcon={<ThumbUpOffAltIcon />}></Button>
                <Button onClick={(event) => console.log(event.target)} variant="contained" color="error" endIcon={<ThumbDownOffAltIcon />}></Button>
            </div>
            {/* {loading ? (
                    <div>
                        <LinearProgress />
